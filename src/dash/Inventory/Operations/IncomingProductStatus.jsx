    ...
    <>
      ...
      <form>
        ...
        >
              ...
              <FormControl fullWidth>
                <TextField
                  ...
                  sx={{
                    ...
                    "& .MuiInputBase-input": { color: "#3BB1D2" },
                  }}
                />
              </FormControl>
            </Grid>
          ...
          <Box sx={inventoryShareStyles.WidthFullFlexSpaceBetween(theme)}>
            <Typography sx={{ color: "#3BB1D2" }}>Drafted</Typography>
            <Button sx={inventoryShareStyles.buttonStyles(theme)}>
              Validate
            </Button>
          </Box>
...
export default IncomingProductStatus;
