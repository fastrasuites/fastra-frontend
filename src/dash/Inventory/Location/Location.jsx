...
const locationType = [
  { type: 'Suppliers Location', desc: 'Products coming in from suppliers (PO).' },
  { type: 'Customers Location', desc: 'Product going out to customers (deliveries).' },
];
...
function Location() {
  ...
  const handleCreateLocationClick = () => {
    history.push('/create-inventory-location'); // Navigate to the LocationForm page
  };
    ...
    <div className='location-contain'>
      ...
      <div style={{ padding: '20px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          <button className='create-location' onClick={handleCreateLocationClick}>Create Location</button>
