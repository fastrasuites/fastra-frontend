...
import { FaBars, FaTimes, FaBell, FaSortDown, FaSortUp } from 'react-icons/fa'; // Import all necessary icons
import { NavLink } from 'react-router-dom';
import admin from '../../image/admin.svg'; // Adjust the path if needed
