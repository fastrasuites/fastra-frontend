...
const AccessRight = ({ onClose, fromStepModal }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // if coming through dashboard popup return to dashboard for the next (3rd) step.
    if (fromStepModal) {
    ...
    <div className="registration-form">
      <form className="registration-info" onSubmit={handleSubmit}>
        <div className="registration-header-info">
          <h2 style={{ fontSize: "20px", fontWeight: "500px" }}>
            Access Rights
          </h2>
